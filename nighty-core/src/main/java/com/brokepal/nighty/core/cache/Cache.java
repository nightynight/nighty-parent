package com.brokepal.nighty.core.cache;
...
public class Cache {
    ...
    public static <K extends Serializable,V extends Serializable> void put(String namespace, String key, V v){
        key = namespace + "-" + key;
    ...
    /** 长时间缓存 */
    public static <K extends Serializable,V extends Serializable> void longPut(String namespace, String key, V v){
        key = namespace + "-" + key;
        Element element = new Element(key,v);
        longCache.put(element);
        cache.remove(key);
    ...
    public static <K extends Serializable, V> V get(String namespace, String key){
        key = namespace + "-" + key;
        Element element;
        V result = null;
        do {
    ...
    public static <K extends Serializable> boolean has(String namespace, String key){
        key = namespace + "-" + key;
    ...
    public static <K extends Serializable> void remove(String namespace, String key){
        key = namespace + "-" + key;
        cache.remove(key);
        longCache.remove(key);
    }
